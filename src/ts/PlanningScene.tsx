...
export default class PlanningScene extends WidgetBase {
  @property() public map: WebScene;
  @property() public view: SceneView;
  @property() public sketchLayer = new GraphicsLayer({
      ...
      symbolLayers: [
        {
          ...
          edges: { type: "solid", color: [150, 150, 150], size: 0.5 },
        },
      ],
    },
  } as any);
  ...
  public constructor(app: App) {
    ...
    this.map = new WebScene({
      portalItem: { id: app.settings.webSceneId },
    });
