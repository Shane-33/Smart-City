...
// Constants for modes
const RELATIVE_TO_SCENE = "relative-to-scene";
const ON_THE_GROUND = "on-the-ground";
...
export default class DrawWidget extends WidgetBase {
  ...
  constructor(params?: any) {
    ...
    this.layer = new GraphicsLayer({
      elevationInfo: {
        mode: RELATIVE_TO_SCENE, // Use constant here
      },
    });
  ...
  public updateGraphic(graphic: Graphic): Promise<Graphic[]> {
    console.log("updateGraphic called"); // Add this line
