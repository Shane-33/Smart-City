...
const utils = require('./utils-3261c8fc.js');
const dom = require('./dom-b708de15.js');
const floatingUi = require('./floating-ui-9bc6fbbb.js');
...
const InputDatePicker = class {
  ...
  render() {
    ...
    return (index.h(index.Host, { onBlur: this.deactivate, onKeyDown: this.keyDownHandler }, this.localeData && (index.h("div", { class: "input-container" }, index.h("div", { class: "input-wrapper", onClick: this.onInputWrapperClick,
      ...
      ref: this.setStartWrapper }, index.h("calcite-input-text", { "aria-autocomplete": "none", "aria-controls": this.dialogId, "aria-describedby": this.placeholderTextId, "aria-expanded": dom.toAriaBoolean(this.open), "aria-haspopup": "dialog", class: `input ${this.layout === "vertical" && this.range ? `no-bottom-border` : ``}`, disabled: disabled, icon: "calendar", onCalciteInputTextInput: this.calciteInternalInputInputHandler, onCalciteInternalInputTextBlur: this.calciteInternalInputBlurHandler, onCalciteInternalInputTextFocus: this.startInputFocus, onFocus: this.startEndInputFocus, placeholder: this.localeData?.placeholder, readOnly: readOnly, role: "combobox", scale: this.scale, status: this.status,
      // eslint-disable-next-line react/jsx-sort-props -- ref should be last so node attrs/props are in sync (see https://github.com/Esri/calcite-design-system/pull/6530)
