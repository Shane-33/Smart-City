...
const breakpoints = {
  width: {
    large: cssLengthToNumber(calciteHeadless.CoreBreakpointWidthDefaultLg),
    medium: cssLengthToNumber(calciteHeadless.CoreBreakpointWidthDefaultMd),
    small: cssLengthToNumber(calciteHeadless.CoreBreakpointWidthDefaultSm),
    xsmall: cssLengthToNumber(calciteHeadless.CoreBreakpointWidthDefaultXs),
    xxsmall: cssLengthToNumber(calciteHeadless.CoreBreakpointWidthDefaultXxs),
  },
};
