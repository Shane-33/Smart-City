...
const filter = require('./filter-beb6a5bb.js');
...
const calciteHeadless = require('./calcite-headless-100c2f24.js');
const debounce = require('./debounce-e86475fb.js');
...
const Combobox = class {
  constructor(hostRef) {
    ...
    this.refreshSelectionDisplay = async () => {
      ...
      const inputWidth = (inputTextWidth || parseInt(calciteHeadless.CoreSizing15)) + chipContainerElGap;
