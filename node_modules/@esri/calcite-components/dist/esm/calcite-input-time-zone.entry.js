...
import { u as updateHostInteraction } from './interactive-69ec9d65.js';
import { e as getDateTimeFormat, c as connectLocalized, d as disconnectLocalized } from './locale-e5414778.js';
  ...
  if (mode === "offset") {
    if (!timeZoneGroups) {
      timeZoneGroups = Promise.all([
        import('./index-8c8901b3.js'),
        import('./index-8a250c5a.js'),
      ]);
    }
